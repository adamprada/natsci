...
\fancyhf{}
\fancyhead[L]{\texttt{natsci-latex} --- Sample document --- Czech}
\fancyfoot[R]{\thepage}
%*******************************************************************************
...
\DefineBibliographyStrings{czech}{% Renaming Odkazy to Použité zdroje
    bibliography = {Použité zdroje},
    references = {Použité zdroje},
}
%*******************************************************************************
% Babel
%*******************************************************************************
\usepackage[czech]{babel} % Note that because of a bug, Babel must be loaded after biblatex
%*******************************************************************************
% Title page
%*******************************************************************************
